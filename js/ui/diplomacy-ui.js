        ...
        buttons: [
          { text: 'Anuluj', class: 'wf-btn-secondary', autoClose: true },
          {
            ...
            onClick: () => {
              ...
              if (!res.success) {
                window.WorldForge.UI.Modal.showError('Przelew Międzynarodowy Nieudany', res.reason);
              }
        ...
        buttons: [
          { text: 'Anuluj', class: 'wf-btn-secondary', autoClose: true },
          {
            ...
            onClick: () => {
              ...
              if (!res.success) {
                window.WorldForge.UI.Modal.showError('Pożyczka Międzypaństwowa Nieudana', res.reason);
              }
              window.WorldForge.UI.Navigation.updateTopBar();
              const drawerContent = document.getElementById('right-drawer-content');
              if (drawerContent) DiplomacyUI.render(drawerContent);
